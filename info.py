...
# Bot information
API_ID = environ.get('API_ID', '26570258')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6734016550:AAFGTIL3_OiH-_gnBNOKw-mg0v2_EPMxjCk')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1790510761')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001998858242')
